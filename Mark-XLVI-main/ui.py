...
try:
    from PyQt6.QtCore import (  # type: ignore
        QMimeData, QObject, QPointF, QRectF, QSize, Qt,
    ...
    # Ensure code that references `pyqtSignal` (from PyQt) works with PySide6
    try:
        from PySide6.QtCore import pyqtSignal  # type: ignore
    except Exception:
